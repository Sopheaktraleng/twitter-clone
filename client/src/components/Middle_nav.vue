<template>
  ...
  <div class="border w-2/3">
    ...
    <top-nav class="w-12">
      <cog-icon class="width=15 height=15"/>
    </top-nav>
          </div>
            ...
            <!-- /Custom Timeline -->
      <!--head-->
      <form @submit.prevent="handleSubmit" @handleSubmit="handleTwit" >
          ...
          >
            <div
              class="flex flex-shrink-0 items-center justify-center py-4 bg-gray dark:bg-dim-900 border-b border-t border-gray-200 dark:border-dim-200 hover:bg-gray-50 dark:hover:bg-dim-300 cursor-pointer transition duration-350 ease-in-out text-blue-400 text-sm"
            >
              Show 9 Tweets
            </div>
          </div>
