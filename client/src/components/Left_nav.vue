<template>
    <div class="p-2 h-screen sticky top-0 w-min lg:w-64">
        <div class="flex flex-col fixed px-3">
          ...
          <div class="mt-5">
            ...
            <menu-item :title="'Communities'">
              <communtities-icon class="w-6 mx-auto lg:mx-0"/>
            </menu-item>
        ...
        <!-- User Menu -->
        <div
              class=" mt-5 w-14 xl:w-full mx-auto  flex flex-row justify-between mb-5 rounded-full hover:bg-blue-50 dark:hover:bg-dim-800 p-2 cursor-pointer transition duration-350 ease-in-out mb-2">
