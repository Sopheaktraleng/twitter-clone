<template>
  <div class="p-2 h-screen top-0 w-min lg:w-64 flex justify-start">
    <div class="flex flex-col fixed lg:px-3">
      <router-link class="w-8" to="/">
        <svg
      ...
      <div class="mt-5">
        ...
        <menu-item
          class="w-8 rounded-full lg:bg-blue font-sans font-bold text-white lg:w-48 lg:h-12 lg:text-xl lg:justify-center lg:rounded-full"
        >
      ...
      <div class="mt-5 lg:mt-20 font-sans">
        <div class="flex flex-row">
          ...
          <div class="flex-col ml-2">
            <h1 class="font-bold text-sm hidden lg:block">Logout</h1>
          </div>
        </div>
      </div>
      <!-- /User Menu -->
...
import CommuntitiesIcon from './icons/CommuntitiesIcon.vue'
import ExploreIcon from './icons/ExploreIcon.vue'
import HomeIcon from './icons/HomeIcon.vue'
import ListIcon from './icons/ListIcon.vue'
import MenuItem from './icons/MenuItem.vue'
