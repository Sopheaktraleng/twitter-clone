<template>
    <div class="flex flex-col lg:flex-row lg:items-center lg:justify-center lg:h-screen font-sans">
        <div class="absolute top-0 left-0 z-20 bg-b text-white p-4 ">
            <router-view></router-view>
        </div>
            <div class="w-8 lg:w-1/2">
                <svg class=" pl-32 w-16 lg:w-full lg:px-32" xmlns="http://www.w3.org/2000/svg"  width="400" height="400" viewBox="0 0 24 24">
...
export default {
    name: "LoginPage",
    components:{GoogleIcon, AppleIcon, DeviderRule, ButtonDefualt},
};
</script>
